"""
Django settings for rccgBackend project.
...
ALLOWED_HOSTS = ['localhost','rccgbackend.herokuapp.com',]
...
WSGI_APPLICATION = 'rccgBackend.wsgi.application'
...
# this setting below is for cors to to restics the website that cam access the api\
